...
function w  = multi_fw_one_full(fwax, faximp, fori, noiseax, scaling, j)
...
for j=1:p+1
    [mean_coeffs_thres, ratiounthres, thres_val]  = multi_fw_one_level(fwax, faximp, fori, noiseax, scaling(j), j);
