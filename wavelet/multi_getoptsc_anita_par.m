...
function alpha = multi_getoptsc_anita_par(z, K,testyori, type, p, sigma, rootmethod)
% example
...
for i=1:p+1
	...
	alpha(i) = a;
	[w, ratiounthr, thrvec] = multi_fpar(z,K,testyori,type,p,sigma,alpha, rho,method);
	fa = ratiounthr(i);
...
for i=1:p+1
	...
	for alphaval =xarray
		alpha(i) = alphaval;
		[w, ratiounthr, thrvec] = multi_fpar(z(1:1024),K(1:1024),type,p,sigma,alpha, rho,method);
